        ...
        public async Task<ActionResult> Edit([Bind(Include = "DepartmentID,Name,Budget,StartDate,RowVersion,InstructorID")] Department department)
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                else
                {
                    ...
                    {
                        ModelState.AddModelError("StartDate", "Current value: " + String.Format("{0:c}", databaseValues.StartDate));
                    }
                    ...
                    ModelState.AddModelError(string.Empty, "The record you attempted to edit " +
                            "was modified by another user after you the the original value. The " +
                            "edit operation was canceled and the current values in the database " +
                            "have been displayed. If you still want to edit this record, click " +
                            "the Save buttone again. Otherwise click the Back to List hyperlink.");
        ...
        public async Task<ActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            else
            {
                ViewBag.ConcurrencyErrorMessage = "The record you attempted to delete " +
                    ...
                    "database hae been displayed. If you still want to delete this " +
